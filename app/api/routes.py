...
@token_required
def get_games_by_game_title(current_user_token,game_title):
...
@token_required
def get_games_by_game_version(current_user_token,game_version):
...
@token_required
def get_games_by_game_region(current_user_token,game_region):
...
@token_required
def get_games_by_game_publisher(current_user_token,game_publisher):
...
@token_required
def get_games_by_game_completed(current_user_token,game_completed):
...
@token_required
def get_games_by_game_value(current_user_token,game_value):
